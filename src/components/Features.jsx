     ...
     <h1 className="lg:text-5xl text-3xl text-center mt-3 pt-5 text-black font-bold tracking-wide mb-5 dark:text-white">FEATURES</h1>
         <div className="lg:m-5 m-10 mt-5">
          <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-5 mb-[20px] place-items-center justify-center" data-aos="fade-up">
            ...
            <div className="grid px-6 py-6 mb-3 mt-3 rounded-lg max-w-[80%] shadow-[20px] h-52 lg:w-[500px] m-10 md:w-[320px] w-[250px] place-items-center  lg:hover:w-[420px] hover:opacity-95 dark:bg-[#66CC7B] bg-gray-200 hover:text-white transition-color duration-200">
            ...
            <div className="px-6 py-4 mb-3 mt-3 rounded-lg max-w-[80%] shadow-[20px] h-52 lg:w-[500px] m-10 md:w-[320px] w-[250px] flex items-center justify-center lg:hover:w-[420px] hover:opacity-95 dark:bg-[#66CC7B] bg-gray-200 hover:text-white transition-color duration-200">
            <div className="grid place-items-center">
