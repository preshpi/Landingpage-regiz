...
function Contactus() {
  ...
  return (
    <div className="grid lg:place-items-center mt-[100px] items-center justify-center font-[poppins]">
      <div className="m-5 grid lg:grid-cols-2">
        <div className="dark:text-[#FFFFFF] text-black md:w-[600px] p-5 place-items-center items-center justify-center">
          <h2 className="font-bolder text-4xl">Get in touch</h2>

          <p className="lg:w-[550px] mt-[50px] leading-8 text-xl">
          ...
          <div>
            ...
            <hr className="border-1 border-[#02383C] lg:w-[500px] w-[343px] mt-[30px]" />
        ...
        <form
          ...
          className="w-[600px] bg-gray-200 rounded-[30px] place-items-center justify-center items-center grid lg:mt-0 mt-32"
        >
          <div className="w-[500px] lg:w-[600px]  place-items-center items-center justify-center flex flex-col">
              ...
              <input
                ...
                className={
                  error && firstName.length <= 0
                    ? "errorname mt-3 w-[343px] lg:w-[448px] px-4 py-4 rounded-[15px] focus:outline-none border border-[#F83F23]"
                    : "inputname mt-3  w-[343px]  lg:w-[448px] px-4 py-4 rounded-[15px] focus:outline-none focus:border focus:border-[#84CAFF]  border border-[#D0D5DD]"
                }
                id="first_name"
                type="text"
              ...
              <textarea
                ...
                className={
                  error && message.length <= 0
                    ? "errormessage mt-3 w-[343px]  lg:w-[448px] px-4 py-4 rounded-[15px] focus:outline-none border border-[#F83F23]"
                    : "messageinput mt-3  w-[343px]  lg:w-[448px] px-4 py-4 rounded-[15px] focus:outline-none focus:border focus:border-[#84CAFF]  border border-[#D0D5DD]"
                }
                id="message"
                type="text"
            ...
            <div className="mt-3 mb-[50px]">
              <button
                ...
                className="mt-3 w-[343px]  bg-[#02383C] hover:bg-[#3CC3A9] ring-opacity-25  focus:ring-4 ring-[#02383C] text-[#FFFF] rounded-[10px] px-5 py-5 lg:w-[448px]"
              >
                Send message
              </button>
            </div>
