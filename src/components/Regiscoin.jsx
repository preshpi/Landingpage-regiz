...
function Regiscoin() {
  return (
    <div name="Regiscoin" className="pt-5 dark:bg-[#070909] bg-gray-100 ">
      <h1 className="lg:text-5xl text-3xl text-center dark:text-white text-black font-bold tracking-wide mb-5 pt-5">
        Regiscoin
      </h1>
      ...
      <div className="dark:bg-[#0C1017] p-8 bg-[#fff]">
        <h1 className="lg:text-5xl text-3xl text-center mt-3 dark:text-white font-bold tracking-wide mb-5 pt-5 text-black">
          Token Distribution
        </h1>
