    ...
    <div className="grid lg:grid-cols-2 lg:m-10 m-5 place-items-center gap-5 lg:gap-10  items-center justify-center  ">
      ...
      <div className="lg:m-20 text-start m-5">
         ...
         <div className="w-full shadow bg-[#323F52] mt-5 rounded-lg">
            <div className="bg-orange-500 text-xs rounded-lg leading-none py-[2px] mb-3 text-center dark:text-white text-black w-36 lg:w-[40%]" data-aos="slide-right"></div>
         </div>

         <p className="dark:text-white text-black text-xl">Team 5%</p>
         <div className="w-full shadow bg-[#323F52] mt-5 rounded-lg">
            <div className="bg-green-500 text-xs rounded-lg leading-none py-[2px] mb-3 text-center dark:text-white text-black w-14 lg:w-[5%]" data-aos="slide-right"></div>
         </div>
         ...
         <div className="w-full shadow bg-[#323F52] mt-5 rounded-lg">
            <div className="bg-blue-500 text-xs rounded-lg leading-none py-[2px] mb-3 text-center dark:text-white text-black w-24 lg:w-[15%]" data-aos="slide-right"></div>
         </div>

         <p className="dark:text-white text-black text-xl">Locked 3%</p>
         <div className="w-full shadow bg-[#323F52] mt-5 rounded-lg">
            <div className="bg-cyan-500 rounded-lg text-xs leading-none py-[2px] mb-3 text-center text-white w-12 lg:w-[3%]" data-aos="slide-right"></div>
         </div>
