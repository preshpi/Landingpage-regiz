...
function About() {
  return (
    ...
    <div className="dark:text-gray-300 about-text text-black">
      ...
      <p className="sm:text-[14px] text-[16px] lg:text-[1rem] md:text-[1rem] mt-3 lg:leading-10 lg:tracking-wider leading-8 break-word justify-center lg:w-full md:w-[450px]">
